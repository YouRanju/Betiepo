...
.menu-item { width: 70px; height: 70px; line-height: 70px;}

.menu-open-button {width: 80px; height: 80px; line-height: 80px;}
...
.menu-open:checked ~ .menu-item:nth-child(5) {
   ...
   -webkit-transform: translate3d(54.9466px, 80.47586px, 0);
